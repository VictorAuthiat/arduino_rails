...
class MeasuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post measures_url, params: { measure: { humidity: @measure.humidity, temperature: @measure.temperature } }
    end
  ...
  test "should update measure" do
    patch measure_url(@measure), params: { measure: { humidity: @measure.humidity, temperature: @measure.temperature } }
